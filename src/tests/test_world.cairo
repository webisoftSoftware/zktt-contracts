...
mod tests {
    ...
    use zktt_contracts::systems::actions::{actions, IActionsDispatcher, IActionsDispatcherTrait};
    use zktt_contracts::models::{Position, m_Position, Moves, m_Moves, Direction};

    fn namespace_def() -> NamespaceDef {
        let ndef = NamespaceDef {
            namespace: "zktt_contracts", resources: [
                ...
                TestResource::Contract(
                    ContractDefTrait::new(actions::TEST_CLASS_HASH, "actions")
                        .with_writer_of([dojo::utils::bytearray_hash(@"zktt_contracts")].span())
                )
            ].span()
        };
